...
do
    ...
    Tabs.Checks = Window:AddTab({ Title = "Sex list", Icon = "list-checks" })
    ...
    local DiscordWikiSection = Tabs.Settings:AddSection("Cop now")
    ...
    if getfenv().setclipboard then
        DiscordWikiSection:AddButton({
            ...
            Callback = function()
                getfenv().setclipboard("https://facebook.com/stephex16")
                Window:Dialog({
                    Title = "Hackz",
